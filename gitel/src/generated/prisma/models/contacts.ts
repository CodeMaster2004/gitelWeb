...
export type contactsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"contact_id" | "name" | "phone" | "email" | "message" | "created_at", ExtArgs["result"]["contacts"]>
...
export interface contactsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const contactsWithContact_idOnly = await prisma.contacts.createManyAndReturn({
   ...
   * const contactsWithContact_idOnly = await prisma.contacts.updateManyAndReturn({
   *   select: { contact_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
