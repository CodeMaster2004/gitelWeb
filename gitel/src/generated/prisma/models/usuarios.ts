...
export type usuariosWhereInput = {
  ...
  user_id?: Prisma.IntFilter<"usuarios"> | number
...
export type usuariosScalarWhereWithAggregatesInput = {
  ...
  user_id?: Prisma.IntWithAggregatesFilter<"usuarios"> | number
...
export type usuariosOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"user_id" | "email" | "password" | "rol" | "created_at", ExtArgs["result"]["usuarios"]>
...
export interface usuariosDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const usuariosWithUser_idOnly = await prisma.usuarios.findMany({ select: { user_id: true } })
   * 
   */
   ...
   * const usuariosWithUser_idOnly = await prisma.usuarios.createManyAndReturn({
   *   select: { user_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * const usuariosWithUser_idOnly = await prisma.usuarios.updateManyAndReturn({
   *   select: { user_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface usuariosFieldRefs {
  readonly user_id: Prisma.FieldRef<"usuarios", 'Int'>
